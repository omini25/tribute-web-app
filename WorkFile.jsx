...
const testimonials = [
    {
        name: "John Smith",
        year: 2022,
        content: "Creating a memorial for my father was a beautiful way to Honour his life. The platform was easy to use, and the support team was incredibly helpful during this difficult time."
    },
    {
        name: "Emily Johnson",
        year: 2023,
    ...
    return (
        <Card className="border-none shadow-md hover:shadow-lg transition-shadow duration-300 bg-white">
            <CardContent className="p-6 flex flex-col items-center text-center">
                <Icon className="h-12 w-12 text-[#fcd34d] mb-4" />
        ...
        <Card className="shadow-md hover:shadow-lg transition-shadow duration-300 bg-[#f8f4f0]">
            <CardContent className="p-6">
                <div className="flex items-center space-x-4 mb-4">
                    <div className="w-12 h-12 rounded-full bg-[#fcd34d] flex items-center justify-center text-white font-medium text-xl">
                        {name.charAt(0)}
                    </div>
                    <div>
