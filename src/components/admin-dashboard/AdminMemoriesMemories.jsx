...
export default function AdminMemoriesMemories() {
    const { id } = useParams()
                    ...
                    {isLoading ? (
                        ...
                        <>
                            ...
                            <CardFooter className="flex flex-col sm:flex-row justify-between items-center border-t p-6 gap-4">
                                ...
                                <div className="flex gap-3 w-full sm:w-auto">
                                    <Link to={`/admin/dashboard/memories/music-theme/${id}`} className="w-full sm:w-auto">
        ...
        <div className="space-y-6">
            <div className="bg-[#f8f4f0] p-6 rounded-lg">
                ...
                <div className="grid md:grid-cols-3 gap-4 mb-6">
                    ...
                    <Card
                        className={`border cursor-pointer transition-all ${fileType === "video" ? "border-[#fcd34d] bg-[#f5f0ea] shadow-md" : "border-[#e5e0d9] hover:border-[#fcd34d] hover:shadow-sm"}`}
