...
export default function MemoriesMusicTheme() {
    ...
    const handlePlanChange = async (newPlanId) => {
        try {
            ...
            const response = await axios.post(`${server}/admin/tributes/${tribute.id}/plan`, {
                plan: newPlanId,
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${server}/admin/tributes/${id}/music`, formData, {
                headers: {
    ...
    const currentPlan = PLANS[tribute.plan] || PLANS.free;
